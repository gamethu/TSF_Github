...
def main():
    ...
    model_keras = NBeatsKeras(backcast_length        = time_steps, 
    ...
    model_pytorch = NBeatsPytorch(backcast_length        = time_steps, 
                                  forecast_length        = output_steps,
                                  stack_types            = (NBeatsPytorch.GENERIC_BLOCK, 
                                                            NBeatsPytorch.GENERIC_BLOCK),
                                  nb_blocks_per_stack    = 2, 
                                  thetas_dim             = (4, 4), 
                                  share_weights_in_stack = True,
                                  hidden_layer_units     = 64)
    ...
    np.testing.assert_equal(predictions_pytorch_forecast.shape,(test_size, model_pytorch.forecast_length,output_steps))
    ...
    np.testing.assert_equal(predictions_pytorch_backcast.shape,(test_size, model_pytorch.backcast_length,output_steps))
